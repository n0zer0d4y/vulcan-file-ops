...
describe("Path Validation", () => {
  ...
  it("allows subdirectories", () => {
    ...
    expect(
      isPathWithinAllowedDirectories("/home/user/project/src/index.js", allowed)
    ).toBe(true);
    expect(
  ...
  describe("Validation Tests - Special Characters", () => {
    ...
    it("handles percent signs in allowed directories", () => {
      ...
      expect(
        isPathWithinAllowedDirectories("/home/user/project files/test", allowed)
  ...
  describe("Path Normalization", () => {
    it("normalizes paths before comparison", () => {
      ...
      // Multiple slashes
      expect(
        isPathWithinAllowedDirectories("/home/user/project//src//file", allowed)
      ).toBe(true);
      expect(
        isPathWithinAllowedDirectories("/home//user//project//src", allowed)
      ).toBe(true);
